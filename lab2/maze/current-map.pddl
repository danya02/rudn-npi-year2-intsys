...
(:init
  ...
  (adjacent t3_1 t2_1)
  (adjacent t3_1 t4_1)
  (gate_at t3_1 bgroup_item)
  (item_at t3_1) ;; cannot place blocks on gates
  (adjacent t4_1 t4_0)
  (adjacent t4_1 t4_2)
  (adjacent t4_1 t3_1)
  (adjacent t4_1 t5_1)
  ...
  (adjacent t7_1 t6_1)
  (adjacent t7_1 t8_1)
  (gate_at t7_1 bgroup_item)
  (item_at t7_1) ;; cannot place blocks on gates
  (adjacent t8_1 t8_0)
  (adjacent t8_1 t8_2)
  (adjacent t8_1 t7_1)
  (adjacent t8_1 t9_1)
  ...
  (adjacent t1_3 t0_3)
  (adjacent t1_3 t2_3)
  (gate_at t1_3 bgroup_item)
  (item_at t1_3) ;; cannot place blocks on gates
  (adjacent t5_3 t5_2)
  (adjacent t5_3 t5_4)
  (adjacent t5_3 t4_3)
  (adjacent t5_3 t6_3)
  (gate_at t5_3 bgroup_item)
  (item_at t5_3) ;; cannot place blocks on gates
  (adjacent t9_3 t9_2)
  (adjacent t9_3 t9_4)
  (adjacent t9_3 t8_3)
  (adjacent t9_3 t10_3)
  (gate_at t9_3 bgroup_item)
  ...
  (adjacent t3_5 t2_5)
  (adjacent t3_5 t4_5)
  (gate_at t3_5 bgroup_item)
  (item_at t3_5) ;; cannot place blocks on gates
  (adjacent t4_5 t4_4)
  (adjacent t4_5 t4_6)
  (adjacent t4_5 t3_5)
  (adjacent t4_5 t5_5)
  ...
  (adjacent t7_5 t6_5)
  (adjacent t7_5 t8_5)
  (gate_at t7_5 bgroup_item)
  (item_at t7_5) ;; cannot place blocks on gates
  (adjacent t8_5 t8_4)
  (adjacent t8_5 t8_6)
  (adjacent t8_5 t7_5)
  (adjacent t8_5 t9_5)
  ...
  (adjacent t1_7 t0_7)
  (adjacent t1_7 t2_7)
  (gate_at t1_7 bgroup_item)
  (item_at t1_7) ;; cannot place blocks on gates
  (adjacent t5_7 t5_6)
  (adjacent t5_7 t5_8)
  (adjacent t5_7 t4_7)
  (adjacent t5_7 t6_7)
  (gate_at t5_7 bgroup_item)
  (item_at t5_7) ;; cannot place blocks on gates
  (adjacent t9_7 t9_6)
  (adjacent t9_7 t9_8)
  (adjacent t9_7 t8_7)
  (adjacent t9_7 t10_7)
  (gate_at t9_7 bgroup_item)
  (item_at t9_7) ;; cannot place blocks on gates
  (adjacent t0_8 t0_7)
  (adjacent t0_8 t0_9)
  (adjacent t0_8 t1_8)
  (walkable t0_8)
  ...
  (adjacent t3_9 t2_9)
  (adjacent t3_9 t4_9)
  (gate_at t3_9 bgroup_item)
  (item_at t3_9) ;; cannot place blocks on gates
  (adjacent t4_9 t4_8)
  (adjacent t4_9 t4_10)
  (adjacent t4_9 t3_9)
  (adjacent t4_9 t5_9)
  ...
  (adjacent t7_9 t6_9)
  (adjacent t7_9 t8_9)
  (gate_at t7_9 bgroup_item)
  (item_at t7_9) ;; cannot place blocks on gates
  (adjacent t8_9 t8_8)
  (adjacent t8_9 t8_10)
  (adjacent t8_9 t7_9)
  (adjacent t8_9 t9_9)
  (block_at t8_9 bgroup_item)
  (item_at t8_9)
  (walkable t8_9)
  (adjacent t9_9 t9_8)
  (adjacent t9_9 t9_10)
